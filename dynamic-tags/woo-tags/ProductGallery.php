...
class ProductGallery extends Data_Tag {
    ...
    public function get_title() {
        return __('Product Gallery Image', 'hw-ele-woo-dynamic');
    }
    ...
    protected function _register_controls() {
        $this->add_control(
            'image_index',
            [
                'label' => __('Image Index', 'hw-ele-woo-dynamic'),
                'type' => Controls_Manager::NUMBER,
                'default' => 0,
                'description' => __('Set the index of the image in the gallery. 0 for the first image.', 'hw-ele-woo-dynamic'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Fallback to Featured Image', 'hw-ele-woo-dynamic'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'hw-ele-woo-dynamic'),
                'label_off' => __('No', 'hw-ele-woo-dynamic'),
                'return_value' => 'yes',
                'default' => 'no',
                'description' => __('If enabled, and there is no gallery or the index is out of bounds, the featured image will be displayed.', 'hw-ele-woo-dynamic'),
            ]
        );
    }
